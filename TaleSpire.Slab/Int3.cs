...
namespace TaleSpire.Slab
{
    ...
    public readonly struct Int3 : IEquatable<Int3>
    {
        ...
        /// <summary>
        /// Smaller-than operator for a vector of integers.
        /// </summary>
        /// <param name="left">The left argument.</param>
        /// <param name="right">The right argument.</param>
        /// <returns>Returns a 3-dimensional result.</returns>
        ...
        /// <summary>
        /// Smaller or equal than operator for a vector of integers.
        /// </summary>
        /// <param name="left">The left argument.</param>
        /// <param name="right">The right argument.</param>
        /// <returns>Returns a 3-dimensional result.</returns>
        ...
        /// <summary>
        /// Greater-than operator for a vector of integers.
        /// </summary>
        /// <param name="left">The left argument.</param>
        /// <param name="right">The right argument.</param>
        /// <returns>Returns a 3-dimensional result.</returns>
        ...
        /// <summary>
        /// Greater or equal than operator for a vector of integers.
        /// </summary>
        /// <param name="left">The left argument.</param>
        /// <param name="right">The right argument.</param>
        /// <returns>Returns a 3-dimensional result.</returns>
        ...
        public static Bool3 operator <(Int3 left, int right)
            => new Bool3(left.X < right, left.Y < right, left.Z < right);
